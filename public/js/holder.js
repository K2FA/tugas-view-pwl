...
(function (app, win) {
    ...
    app.run = function (o) {
        ...
        if (typeof options.images == "string") {
            ...
            window.NodeList &&
            options.images instanceof window.NodeList
        ) {
        ...
        if (typeof options.bgnodes == "string") {
            ...
            window.NodeList &&
            options.elements instanceof window.NodeList
        ) {
        ...
        for (var l = bgnodes.length, i = 0; i < l; i++) {
            ...
            if (flags) {
                ...
                var holder = parse_flags(
                    bgsrc
                        .substr(
                            bgsrc.lastIndexOf(options.domain) +
                                options.domain.length +
                                1
                        )
                        .split("/"),
                    options
        ...
        for (l = images.length, i = 0; i < l; i++) {
            ...
            if (
                ...
                !!attr_datasrc &&
                attr_datasrc.indexOf(options.domain) >= 0
            ) {
                src = attr_datasrc;
            }
            if (src) {
                var holder = parse_flags(
                    src
                        .substr(
                            src.lastIndexOf(options.domain) +
                                options.domain.length +
                                1
                        )
                        .split("/"),
